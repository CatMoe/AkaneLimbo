...
public class PositionLook extends AbstractPacket {
    public final static List<ProtocolMapping> MAPPINGS = Arrays.asList(
    ...
    public String toString() {
        return "PositionLookPacket(x=" + getX() + ", y=" + getY() + ", z=" + getZ() + ", yaw=" + getYaw() + ", pitch="
                + getPitch() + ", flags=" + getFlags() + ", teleportId=" + getTeleportId() + ", dismountVehicle="
                + getDismountVehicle() + ")";
    }

    public void PositionLookPacket() {
        this.x = 0;
        this.y = 0;
        this.z = 0;
        this.yaw = 0;
    ...
    public void PositionLookPacket(double x, double y, double z, float yaw, float pitch, byte flags, int teleportId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PositionLook)) {
            return false;
        }
        PositionLook other = (PositionLook) ((Object) o);
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PositionLook;
    }
